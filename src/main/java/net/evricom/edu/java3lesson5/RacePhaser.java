...
/**
 * created by dima on 07.09.2019 2:04
 */

class TestRacePhaser {
    public static final int CARS_COUNT = 4;

    public static void main(String[] args) {
        System.out.println("ВАЖНОЕ ОБЪЯВЛЕНИЕ >>> Подготовка!!!");
        RacePhaser race = new RacePhaser(new RoadPhaser(60), new TunnelPhaser(), new RoadPhaser(40));
